...
sys.path.append(os.path.join(proj_dir, "cd_loss_utils/ChamferDistancePytorch"))
...
# def get_loss(pcds_pred, partial, gt, sqrt=False):
#     """loss function
#     Args
...
#     loss_all = cdc + cd1 + cd2 + cd3 + partial_matching
